...
export default function LandingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Pre-fill WhatsApp message for fallback
      const waText = `היי, ניסיתי לשלוח פנייה דרך האתר אך הייתה שגיאת חיבור. הנה הפרטים שלי לבדיקת רווחיות:
👤 שם מלא: ${fullName}
🏢 שם העסק: ${companyName}
📧 אימייל: ${email}
📞 טלפון: ${phone}
📦 מוצר לייבוא: ${product}`;
      ...
      const waUrl = `https://wa.me/972555172571?text=${encodedText}`;
      setWhatsappFallbackUrl(waUrl);
      setShowWhatsappModal(true);

      showToast('אירעה שגיאת חיבור. באפשרותך לשלוח את הפרטים ישירות לוואטסאפ.', 'error');
    } finally {
    ...
    <div className="w-full bg-[#F8FAFC] text-[#1E293B] min-h-screen selection:bg-[#2563EB] selection:text-white" dir="rtl">
            ...
            {isSuccess ? (
              <div className="py-12 flex flex-col items-center justify-center text-center animate-fade-in">
                ...
                <p className="text-slate-300 text-sm max-w-md mb-8 leading-relaxed">
                  תודה רבה! פרטיך התקבלו במערכת ה-CRM שלנו וצוות הלוגיסטיקה כבר בודק אותם. נחזור אליך בהקדם עם תחזית חיסכון מדויקת.
                  <span className="block mt-4 text-emerald-400 font-bold">
                    לא בא לך לחכות? לחץ כאן ופנה אלינו ישירות בוואטסאפ:
                  </span>
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full max-w-sm">
                  <a
                    href="https://wa.me/972555172571?text=%D7%94%D7%99%D7%99%2C%20%D7%94%D7%A9%D7%90%D7%A8%D7%AA%D7%99%20%D7%A4%D7%A8%D7%98%D7%99%D7%9D%20%D7%91%D7%90%D7%AA%D7%A8%20%D7%95%D7%90%D7%A9%D7%9E%D7%97%20%D7%9C%D7%91%D7%93%D7%99%D7%A7%D7%AA%20%D7%A8%D7%95%D7%95%D7%97%D7%99%D7%95%D7%AA%20%D7%9E%D7%94%D7%99%D7%A8%D7%94"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="px-6 py-3 bg-[#25D366] hover:bg-[#20ba59] text-white font-bold rounded-xl text-xs transition-all shadow-lg shadow-emerald-500/25 flex items-center justify-center gap-2 cursor-pointer w-full sm:w-auto"
                  >
                  ...
                  <button
                    ...
                    className="px-6 py-3 text-xs font-semibold text-slate-300 hover:text-white bg-slate-800/80 rounded-xl transition-all border border-slate-700/50 hover:border-slate-600 active:scale-95 cursor-pointer w-full sm:w-auto"
                  >
                    שלח פנייה נוספת
                  </button>
                </div>
      ...
      {showWhatsappModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-fade-in" dir="rtl">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 max-w-md w-full shadow-2xl text-right animate-scale-in">
            ...
            <h3 className="text-lg font-bold text-white mb-2">אירעה שגיאת תקשורת קלה</h3>
            <p className="text-slate-300 text-sm leading-relaxed mb-6">
              לא הצלחנו לשמור את הפרטים שלך בשרת בגלל בעיית חיבור. כדי שהבדיקה שלך לא תתעכב, נשמח אם תשלח לנו את הפרטים ישירות לוואטסאפ בלחיצה אחת!
            </p>
            <div className="flex flex-col sm:flex-row-reverse gap-3">
              <a
                ...
                className="flex items-center justify-center gap-2 px-5 py-3 bg-[#25D366] hover:bg-[#20ba59] text-white font-bold rounded-xl text-sm transition-all shadow-lg shadow-emerald-500/20 active:scale-95 text-center cursor-pointer"
              >
                <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current">
                  <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                </svg>
              ...
              <button
                onClick={() => setShowWhatsappModal(false)}
                className="px-4 py-3 bg-slate-800 hover:bg-slate-700 text-slate-300 font-semibold rounded-xl text-sm transition-all active:scale-95 cursor-pointer"
              >
                סגור
              </button>
            </div>
